...
class DepositProduct(models.Model):
    ...
    join_deny = models.IntegerField(null=True, default=1)                   # 가입제한(1:제한없음, 2: 서민전용, 3:일부제한)
...
class DepositOptions(models.Model):
    product = models.ForeignKey(DepositProduct, on_delete=models.CASCADE, related_name="options")           # 외래키(product 참조)
    ...
    save_trm = models.IntegerField(null=True, default=-1)                           # 저축기간(단위: 개월)
